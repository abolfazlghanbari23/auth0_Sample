...
Configure the application with details of the Auth0 domain and client ID of your application. Locate the `/app/src/main/res/values/strings.xml` file and replace the placeholder `jHz62ybrq0wUYWKcFqYwq2Kg9jmXCWQv` and `dev-jgx2ve45.us.auth0.com` values with your application's client ID and domain.
...
<resources>
    ...
    <string name="com_auth0_client_id">jHz62ybrq0wUYWKcFqYwq2Kg9jmXCWQv</string>
    <string name="com_auth0_domain">dev-jgx2ve45.us.auth0.com</string>
